...
export type FindAllForDropdownQueryVariables = Exact<{ [key: string]: never; }>;


export type FindAllForDropdownQuery = { __typename?: 'Query', findAllForDropdown: Array<{ __typename?: 'DepartmentDropdown', id: string, name: string, description: string }> };
...
export const FindAllForDropdownDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FindAllForDropdown"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findAllForDropdown"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<FindAllForDropdownQuery, FindAllForDropdownQueryVariables>;
